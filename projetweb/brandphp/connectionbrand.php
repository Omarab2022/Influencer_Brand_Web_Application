<!--/**
 * A class for performing CRUD operations on a MySQL database.
 *
...
class crud {
  ...
  /**
   * Update the user data in the database for the given id.
   */
...
// replacing the old username with the provided parameters.
...
// le nom de chaque fonction explique sont roll
