...
<!--
 * This script creates a new instance of the CRUD class and sets the database connection parameters.
 * It also checks if there is a login error message in the URL and assigns it to a variable.
 *
...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="form-box">
                ...
                <div class="btn-field">
                  ...
                  <?php 
        /**
         * If the $login_err variable is not empty, display an alert message with the error and reset the variable to an empty string
         */
        if(!empty($login_err)  ){
        ...
        <script>
         ...
         /**
         """
         This code initializes variables for the sign up button, sign in button, name field, and title. 
          */
         ...
         /**
          * Adds an event listener to the submit button that checks if the password and verify password fields match.
          * If they do not match, an alert is displayed and the form submission is prevented.
          *
