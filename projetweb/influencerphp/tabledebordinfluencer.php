...
<?php 
/**
 * This script retrieves the necessary data from the session and the database to display the dashboard for a brand user.
 * @param string $dbname The name of the database to connect to.
 * @param string $host The host name and port number of the database server.
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="influencercss/styletabledebordinfluencer.css" />
  </head>
  <body>
    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu">
        <ul>
          <li><a href="../pageprinc.php"><img src="influencerimg/home.jpg" alt="" />&nbsp;<span  style="color:aliceblue;">Home</a></span></li>
    ...
    <div class="main-content">
      ...
      <!--header recherche et image de l'utilisateur-->
      <header>
        ...
        <div class="social-icons">
          ...
          <div> <?= '<img style="width:4em;height:4em;border-radius: 50%; margin:0 10px; border : 2px solid black" src="./influencerimg/'.$photo.'">';?> </div>
      </div></div>
        </div>
      </header>
        ...
        <div class="hello">
          <div class="card-body1">
            <!--partie 1 -->
              ...
              <span class="card1">
                <img src="influencerimg/Eurostavka_ Welcome illustration.png" alt="">
             </span>
          </div>
       </div>
      ...
      <div class="content">
        <div class="cards">
          <div class="card">
            <div class="icon-case">
              <img src="influencerimg/8.png" alt="" />
            </div>
          </div>
        ...
        <div class="dash-cards">
            <div class="card-single">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <h5>our influencers</h5>
                        <h4><?php echo $numberinf; ?></h4>
                    </div>

                    <span class="card2">
                      <img src="influencerimg/10 Fundamental Rules You Can't Afford To Ignore When It Comes To Wordpress Issues Fix_.jpeg" alt="">
                    </span>

                </div>
                 
                <div class="card-footer">
                    <a href="ourinfluencers.php">View all</a>
                </div>
            </div>
            ...
            <div class="card-single">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <!--/**
                         * Generates an HTML heading element with the number of collaborations.
                         */-->
                        <h4><?php echo $numbercollabs; ?></h4>
                    </div>

                    <span class="card2">
                      <img src="influencerimg/Instagram - Create Don't Hate Official Posters.jpeg" alt="">
                   </span>
                </div>
                <div class="card-footer">
